...
italia = Pais('Italia')
italia.add_ciudad(sorrento, roma)
...
#agrego hoteles al viaje...
italia_2019.add_hotel(Estadia(date(2019,6,7), date(2019,7,14), hoteles[1]))
italia_2019.add_hotel(Estadia(date(2019,7,14), date(2019,7,20), hoteles[2]))
